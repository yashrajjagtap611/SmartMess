...
router.get('/system', requireAuth_1.default, requireAdmin, async (req, res, next) => {
    try {
...
router.put('/system', requireAuth_1.default, requireAdmin, async (req, res, next) => {
    try {
        const { features, limits, maintenanceMode, maintenanceMessage } = req.body;
        // Validate input
...
router.get('/security', requireAuth_1.default, requireAdmin, async (req, res, next) => {
    try {
...
router.put('/security', requireAuth_1.default, requireAdmin, async (req, res, next) => {
    try {
        const { authentication, password, rateLimiting, cors, headers } = req.body;
        // Validate input
...
router.get('/email', requireAuth_1.default, requireAdmin, async (req, res, next) => {
    try {
        const emailSettings = {
...
router.put('/email', requireAuth_1.default, requireAdmin, async (req, res, next) => {
    try {
        const { provider, smtp, templates, defaults, rateLimiting } = req.body;
        // Validate input
...
router.get('/notifications', requireAuth_1.default, requireAdmin, async (req, res, next) => {
    try {
...
router.put('/notifications', requireAuth_1.default, requireAdmin, async (req, res, next) => {
    try {
        const { push, email, sms, inApp, preferences } = req.body;
        // Validate input
...
router.post('/test-email', requireAuth_1.default, requireAdmin, async (req, res, next) => {
    try {
...
router.get('/backups', requireAuth_1.default, requireAdmin, async (req, res, next) => {
    try {
