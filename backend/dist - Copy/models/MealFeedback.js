...
const MealFeedbackSchema = new mongoose_1.Schema({
    messId: {
        type: String,
        required: true,
        ref: 'MessProfile'
...
exports.default = mongoose_1.default.model('MealFeedback', MealFeedbackSchema);
//# sourceMappingURL=MealFeedback.js.map