...
const messMembershipSchema = new mongoose_1.Schema({
    userId: {
...
messMembershipSchema.statics['cleanupExpiredRequests'] = async function () {
    ...
    for (const request of expiredRequests) {
        ...
        await mongoose_1.default.model('Notification').updateMany({
...
const MessMembership = mongoose_1.default.model('MessMembership', messMembershipSchema);
exports.default = MessMembership;
//# sourceMappingURL=MessMembership.js.map