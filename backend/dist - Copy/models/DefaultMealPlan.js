...
const DefaultMealPlanSchema = new mongoose_1.Schema({
    name: {
        type: String,
        required: true,
        trim: true,
...
exports.default = mongoose_1.default.model('DefaultMealPlan', DefaultMealPlanSchema);
//# sourceMappingURL=DefaultMealPlan.js.map