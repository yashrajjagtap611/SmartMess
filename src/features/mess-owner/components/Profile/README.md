# Mess Owner Profile Component

## Overview

A comprehensive, professional Profile component for Mess Owners with modern UI design, proper backend connectivity, and enhanced user experience.
...
### Profile Management
- `GET /api/mess-owner/profile` - Fetch profile data
- `PUT /api/mess-owner/profile` - Update profile information
- `POST /api/mess-owner/profile/avatar` - Upload profile picture
...
```tsx
import { Profile } from '@/features/mess-owner/components/Profile';
...
- **Business Information**: Mess details, license, establishment date
- **Statistics**: User count, revenue, ratings, reviews
- **Status**: Account status, verification status
